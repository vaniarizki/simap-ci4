...
<div class="wrapper fadeInDown">
  ...
  <div id="formContent">
    ...
    <form action="/user/hibah/upload" method="post" enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <h4>Upload Barang Hibah</h4>
      <div id="imageSection">
      ...
      <td><input type="submit" name="submit" class="fadeIn sixth" value="Hibahin"></td>
    </form>
