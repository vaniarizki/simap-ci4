              ...
              <?php foreach ($barang as $b) : ?>
                <div class="col-md-6 col-sm-6" style="padding-top: 15px;">
                  <div class="small-box-c">
                    ...
                    <div class="prod-btn">
                      <a href="/user/barang/<?= $b['id_barang']; ?>"><i class="fa fa-star" aria-hidden="true"></i>Detail Barang</a>
            ...
            <div class="right-list-f">
              <ul>
                <?php foreach ($kategori as $k) : ?>
                  <li><a href="/user/kategori/<?= $k['nama']; ?>"><img width="32" src="/img/product/<?= $k['gambar']; ?>" alt="#" /><?= $k['nama']; ?></a></li>
                <?php endforeach; ?>
              </ul>
            </div>
          </div>
