...
<div class="wrapper fadeInDown">
  ...
  <div id="formContent">
    <h2 class="inactive underlineHover"><a href="/user/jual">Jual</a></h2>
    <h2 class="inactive underlineHover"><a href="/user/hibah">Hibah</a></h2>
    <h2 class="active">Sewa</h2>
    ...
    <form action="/user/sewa/upload" method="post" enctype="multipart/form-data">
      <?= csrf_field(); ?>
      <h4>Upload Barang Sewaan</h4>
      <div id="imageSection">
      ...
      <td><input type="text" id="harga" class="fadeIn third" name="harga" placeholder="biaya sewa/hari" required></td>
      ...
      <td><input type="submit" name="submit" class="fadeIn sixth" value="Sewain"></td>
    </form>
